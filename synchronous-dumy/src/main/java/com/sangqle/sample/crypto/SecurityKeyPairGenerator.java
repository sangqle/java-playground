...
public class SecurityKeyPairGenerator {
    ...
    public static void main(String[] args) {
        try {
            ...
            File publicKeyFile = createKeyFile(new File("/Users/sanglq3/ZTE/MPTeam/publicKey.rsa"));
            File privateKeyFile = createKeyFile(new File("/Users/sanglq3/ZTE/MPTeam/privateKey.rsa"));
